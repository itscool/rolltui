...
/* Registers ALL TEN built-in kinds — `rows`, `text`, `file`, `help`, `input`, `transcript`,
 * `menu`, `theme`, `keys` — and the error/panel fallbacks. Called once, at construction, AFTER every setter in
